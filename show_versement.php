...
$data = execute('versement');

echo '<div class="row"><div class="col col-md-2"></div><div class="col col-md-8">';
echo '<ol class="breadcrumb"> <li><a href="/">Accueil</a></li> <li><a href="#">Demandes</a></li> <li class="active">Versement</li> </ol>';
...
foreach($data as $user){
  ...
  '<center><h1>Versement d\'argent</h1></center><br/>'.
