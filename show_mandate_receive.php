...
$data = execute('mandate_receive');

echo '<div class="row"><div class="col col-md-2"></div><div class="col col-md-8">';
echo '<ol class="breadcrumb"> <li><a href="/">Accueil</a></li> <li><a href="#">Demandes</a></li> <li class="active">Mandat reçu</li> </ol>';

echo '<table class="table table-hover table-striped"> <thead> <tr> <th>#</th> <th>Mantant</th> <th>Expéditeur</th> <th>Mandate_num</th> <th>Client</th> <th>Date</th> <th>action</th> </tr> </thead><tbody>';
if(count($data))
foreach($data as $user){
  ...
  '<center><h1>Mandat reçu</h1></center><br/>'.
